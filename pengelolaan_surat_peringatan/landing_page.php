...
<head>
    ...
    <link rel="stylesheet" href="assets/css/VARIABEL.CSS">
        ...
        <div class="container">
            ...
            <div class="team-grid">
                ...
                <div class="team-card">
                    ...
                    <p class="team-role">Autentifikasi Halaman Log in & landing Page</p>
                    <p class="team-description">membuat halaman log in dan landing page.</p>
                </div>
                <div class="team-card">
                    <div class="team-photo">
                    ...
                    <p class="team-description">generate dashboard mahasiswa.</p>
                </div>
                <div class="team-card">
                    <div class="team-photo">
